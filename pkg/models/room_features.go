...
// ChangeSharedNotepadStatus toggles the shared notepad active state.
func (m *RoomModel) ChangeSharedNotepadStatus(r *plugnmeet.ChangeSharedNotepadStatusReq) error {
	log := m.logger.WithFields(logrus.Fields{
		"roomId":   r.RoomId,
		"isActive": r.IsActive,

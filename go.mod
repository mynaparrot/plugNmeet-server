...
require (
	...
	github.com/antoniodipinto/ikisocket v0.0.0-20220806220653-2e4f04aebe6a
...
require (
	...
	github.com/mynaparrot/plugnmeet-protocol v0.0.0-20220809050125-7cd8a08ae836 // indirect
